 ...
 */
class OTPLoginGrant extends AbstractGrant
{
    /**
     * Grant identifier
     *
     * @var string
     */
    protected $identifier = 'otp_login';
    ...
    public function completeFlow()
    {
        ...
        if (is_null($mobile)) {
            throw new Exception\InvalidRequestException('mobile');
        }
        ...
        $userId = call_user_func($this->getVerifyCredentialsCallback(), $mobile, $otp);
