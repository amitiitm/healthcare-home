                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            {!! Form::open(['url' => '/admin/enquiry/create','id'=>"create_enquiry"]) !!}        
                            ...
                            <fieldset class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            {!!Form::text('email', '',$attributes = ['class'=>"form-control",'maxlength' => 100])!!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">                                                
                                            {!!Form::text('phone', '',$attributes = ['class'=>"form-control",'maxlength' => 11,'id' => 'phone'])!!}
                                        </div>
                                ...
                                <div class="form-group">                                    
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">                                                
                                            {!! Form::select('user_type', $user_types,'',['class'=>"form-control",'id' => 'user_type']) !!}                                                                                        
                                        </div>
                                        <div class="followup_date_div">
                                            {!!Form::label('followup_date', 'FollowUp Date:', ['class' => 'col-sm-2 control-label'])!!}
                                            <div class="col-sm-4">  
                                                {!!Form::date('followup_time', '',['class'=>"form-control",'id' => 'followup_time'], 'd/m/Y')!!}
                                            </div>
                                        </div>
                                    </div>
                                </div>                              
                                ...
                                <div class="form-group ">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-10">
                                            {!!Form::text('message', '',$attributes = ['class'=>"form-control",'maxlength' => 250])!!}                                                
                                        </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label"></label>
                                    <button class="btn btn-primary " type="button" id="create_enquiry_button"><i class="fa fa-check"></i>&nbsp;Save Followup</button>                                      
...
<script type="text/javascript">
    ...
    $('#status').on('change', function () {
        if (this.value == "{!!strtolower(PramatiConstants::FOLLOW_UP)!!}") {
