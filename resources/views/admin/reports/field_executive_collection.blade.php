...
<?php
$menuSelected = "field_executive_collection";
...
@section('title')
Field Executive Collection Report
@endsection
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Field Executive Collection Report</h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Reports</a>
            </li>
            <li class="active">
                <strong>Field Executive Collection</strong>
            </li>
        </ol>
    </div>
</div>
...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
    <div class="ibox-content m-b-sm border-bottom">
        <div class="row">
            <form method="POST" action="/reports/field_executive_collection">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label class="control-label" for="price">Field Executive</label>
                        {!! Form::select('assigned_user_id', $lead_references,$request -> assigned_user_id,['class'=>"form-control",'id' => 'assigned_user_id', 'placeholder' => '-Please Select Field Executive-']) !!}                        
                    </div>
                </div>
