...
@section('content')
    ...
    <div id="new-lead-view" ng-controller="VendorEditController">
        <div class="page-title">
            <span class="title">Edit Caregiver</span>
            <div class="pull-right">
                <button class="btn btn-success" ng-click="updateVendor()">Update and Exit</button>
            </div>
            <div class="pull-right ng-hide">
                <button class="btn btn-success" ng-click="updateVendor()">Update</button>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="sub-titles required" ng-if="vendorData.source.name == 'Agency'">Agency</div>
                                <div class="sub-title" ng-if="vendorData.source.name == 'Agency'">
                                ...
                                <div>
                                    <input type="text" class="form-control" ng-model="vendorData.alternateNo"  placeholder="Alternate Number">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div ng-show="vendorData.gender.slug == 'F'">
                                    <div class="btn-group">
                                        <label class="btn btn-success btn-sm" ng-model="vendorData.worksForMale" uib-btn-radio="true" uncheckable>Yes</label>
                                        <label class="btn btn-success btn-sm" ng-model="vendorData.worksForMale" uib-btn-radio="false" uncheckable>No</label>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <ui-select ng-model="vendorData.shift"  theme="bootstrap">
                              ...
                              <div class="sub-title required">Task Performed</div>
                                ...
                                <div>
                                    <div class="btn-group" tooltip-class="tooltip-error" >
                                        <label class="btn btn-success btn-sm" ng-model="vendorData.hasSmartPhone" uib-btn-radio="true" uncheckable>Yes</label>
                                        <label class="btn btn-success btn-sm" ng-model="vendorData.hasSmartPhone" uib-btn-radio="false" uncheckable>No</label>
                                    </div>
                                ...
                                <div>
                                    <div class="btn-group">
                                        <label class="btn btn-success btn-sm" ng-model="vendorData.hasBankAccount" uib-btn-radio="true" uncheckable>Yes</label>
                                        <label class="btn btn-success btn-sm" ng-model="vendorData.hasBankAccount" uib-btn-radio="false" uncheckable>No</label>
                                    </div>
                                ...
                                <div ng-show="vendorData.hasBankAccount">
                                    <div class="sub-title required">Account Holder Name</div>
                                    <div>
                                        <input type="text" class="form-control" ng-model="vendorData.bankDetail.name"  placeholder="Account Holder Name" >
                                    ...
                                    <div>
                                        <input type="text" class="form-control" ng-model="vendorData.bankDetail.account_no"  placeholder="Bank Account Number" tooltip-class="tooltip-error" uib-tooltip="{{vendorDataValidation.x}}" tooltip-is-open="!vendorDataValidation.VendorPhone.valid" tooltip-trigger="none" tooltip-placement="bottom-left">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" ng-model="vendorData.bankDetail.bank_name"  placeholder="Bank name" tooltip-class="tooltip-error" uib-tooltip="{{vendorDataValidation.x}}" tooltip-is-open="!vendorDataValidation.VendorPhone.valid" tooltip-trigger="none" tooltip-placement="bottom-left">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="form-control" ng-model="vendorData.bankDetail.ifsc"  placeholder="Bank IFSC Code" tooltip-class="tooltip-error" uib-tooltip="{{vendorDataValidation.x}}" tooltip-is-open="!vendorDataValidation.VendorPhone.valid" tooltip-trigger="none" tooltip-placement="bottom-left">
                                ...
                                <div>
                                    <div class="btn-group">
                                        <label class="btn btn-success btn-sm" ng-model="vendorData.trainingAttended" uib-btn-radio="true" uncheckable>Yes</label>
                                        <label class="btn btn-success btn-sm" ng-model="vendorData.trainingAttended" uib-btn-radio="false" uncheckable>No</label>
                                    </div>
                                ...
                                <div ng-show="vendorData.trainingAttended==1">
                                    <div class="sub-title">Date of Training</div>
                                    <div>
                                        <input type="date" name="training_attended_date" ng-model="vendorData.trainingDate" />
                                    </div>
                                </div>
                                <div ng-show="vendorData.trainingAttended==0">
                                    <div class="sub-title">Reason why training is not attended?</div>
                                    <div>
                                        <ui-select ng-model="vendorData.trainingNotAttendedReason" theme="bootstrap" >
                                        ...
                                        <br />
                                        <div>
                                            <input type="text" class="" ng-model="vendorData.trainingNotAttendedOtherReason" placeholder="Other Reason" />
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <input type="text" class="form-control" ng-model="vendorData.voter" value=""  placeholder="{{vendorData.voter || 'Voter Id'}}" >

                                    <div class="validation-error" ng-show="!vendorDataValidation.voter.valid && vendorDataValidation.voter.$touched">
                                ...
                                <ul class="list-group">
	                                <li class="list-group-item" ng-repeat="document in vendorDocuments" ng-show="!document.deleted">
	                                    <a href="{{document.document.documentUrl}}"  target="_blank">
	                                        <span ng-bind="document.document.caption"></span>
	                                        <span ng-show="document.document.caption==''">
	                                            <span ng-bind="document.document.filename"></span>
	                                        </span>
	                                        <strong>(<span ng-bind="document.document.documentType.label"></span>)</strong>
	                                    </a>

	                                    <button class="btn btn-xs btn-danger pull-right no-margin" ng-click="deleteDocument(document)" title="Delete vendor">
   ...
   <!-- <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div ng-repeat="taskCat in vendorData.validationData">
	...
	<script type="text/ng-template" id="deleteVendorDocumentModalTemplate.html">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="sub-title">Do you really want to delete this document?</div>
        ...
        <div class="modal-footer">
            <button class="btn btn-success" type="button" ng-click="deleteDocument()">Yes Delete</button>
