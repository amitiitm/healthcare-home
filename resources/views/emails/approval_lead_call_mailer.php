    ...
    <table cellspacing="0" cellpadding="5"  width="600" style="background: #FFFFFF">
        ...
        <tr>
            <td colspan="2">
                ...
                <div>
                    System is going to initiate automated call to following lead. If you already contacted the customer please approve the status to prevent the automated call
                </div>
                <br />
            </td>
        </tr>
