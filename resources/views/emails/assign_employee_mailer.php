...
<body>
<div class="zw-paginated zw-page" style="width: 600px; height: auto; position: relative; margin: auto; background: #FFFFFF;">
    <table cellspacing="0" cellpadding="5"  width="600" >
            ...
            <td colspan="2">
                ...
                <div>
                    ...
                    if(isset($lead->userCreated)){
                        echo "New lead is created by ".$lead->userCreated->name." please assign employee for validation:";
                    }else{
                        echo "New lead is created please assign employee:";
                    }
                    ?>
                </div>
                <br />
        ...
        <tr>
            ...
            <td><a href="<?php echo $leadUrl; ?>">xxxxxxxxxx</td>
        </tr>
        <tr>
