...
<div class="zw-paginated zw-page" style="width: 600px; height: auto; position: relative; margin: auto; background: none rgb(255, 255, 255);">
    <table cellspacing="0" cellpadding="5"  width="600" style="">
        <tr>
        ...
        <tr>
            <td colspan="2">
                Dear <?php echo $assigneeUser->name; ?><br /><br />
                <div>
                    <p>You are assigned as field executive to following lead:</p>
                </div>
                <br />
            </td>
        </tr>
        ...
        <tr style="">
            <td colspan="2">
                ...
                <div style="text-align: center">
                    <a href="<?php echo $carePlanUrl; ?>">Click to View Care Plan</a>
                </div>
            </td>
        </tr>
