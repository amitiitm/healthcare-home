		...
		<tr>
			<td colspan="2">
				...
				<div class="zw-contentpane selectableSection" style=" margin-top: 0px; position: relative;">
                        <p class="zw-portion" data-text-len="15" style="color: rgb(111, 111, 111);">Dear <?php echo $lead->customer_name ?>  </p>
                        
                        <p class="zw-portion" data-text-len="15" style="color: rgb(111, 111, 111);">Please find the attached invoice for the period of <?php echo date_format(new DateTime($invoice->invoice_from_date), "d F, Y") ?> to <?php echo date_format(new DateTime($invoice->invoice_to_date), "d F, Y")?></p>
