...
<script>
	...
	<div id="new-lead-view" ng-controller="operationLeadValidateCtrl">
		<div class="page-title">
            <span class="title">Validate Lead</span>
            <div class="pull-right">
                <button class="btn btn-default" ng-click="showValidationPitch()">Validation Pitch</button>
                <button class="btn btn-success" ng-click="updateLeadAndValidate()">Update and Validated</button>
                <button class="btn btn-success" ng-click="rejectLead()">Reject</button>
                <button class="btn btn-success" ng-click="postponeLead()">Postpone</button>
                <button class="btn btn-success" ng-click="followUpLead()">Follow-up</button>
            </div>
        </div>
            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="sub-title">Other Ailment</div>
                        <div>
			...
			<div class="col-md-6">
				<div class="card">
	                ...
	                <div class="card-body">
                        ...
                        <div>
                            <div class="btn-group">
                                <label class="btn btn-success btn-sm" ng-model="leadData.request.medicine" uib-btn-radio="true" uncheckable>Yes</label>
                                <label class="btn btn-success btn-sm" ng-model="leadData.request.medicine" uib-btn-radio="false" uncheckable>No</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                                <div ng-show="leadData.request.medicine" class="sub-title">Medicine Name</div>
                                <div ng-show="leadData.request.medicine">
                                    <input class="form-control" type="text"  placeholder="Patient's Medicine">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div ng-show="leadData.request.medicine" class="sub-title">Time</div>
                                <div ng-show="leadData.request.medicine">
...
the	details	of your patient. Can I ask	you few	details	in	respect	to	your patient so	that I can	provide	you with the appropriate attandant.</p>
    ...
    <script type="text/ng-template" id="rejectLeadModal.html">
        <div class="modal-header">
            <h3 class="modal-title">Reject Lead</h3>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
					<div class="sub-title">Choose Rejection Reason</div>
	                <div>
	                    <select tabindex="-1" class="select2-hidden-accessible" aria-hidden="true" ng-model="requestData.reason">
	                        <option value="{{reason.id}}" ng-repeat="reason in status.reasons"><span ng-bind="reason.label"></span>{{reason.label}}</option>

	                    </select>
	                </div>
	                <div class="sub-title">Any Comment</div>
	                <div>
	                    <textarea class="form-control" ng-model="requestData.comment" rows="3"></textarea>
	                </div>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-success" type="button" ng-click="updateStatus()" ng-disabled="!requestData.reason">Update</button>

            <button class="btn btn-default" type="button" ng-click="cancel()">Close</button>
        </div>
    </script>
    <script type="text/ng-template" id="followupLeadModal.html">
        <div class="modal-header">
            <h3 class="modal-title">Follow-up Lead</h3>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
					<div class="sub-title">Choose Follow-up Reason</div>
	                <div>
	                    <select tabindex="-1" class="select2-hidden-accessible" aria-hidden="true" ng-model="requestData.reason">
	                        <option value="{{reason.id}}" ng-repeat="reason in status.reasons"><span ng-bind="reason.label"></span>{{reason.label}}</option>
	                ...
	                <div>
                        <input placeholder="Select start date" type="date" ng-model="requestData.data.date"  />
                    </div>
	                <div class="sub-title">Any Comment</div>
	                <div>
	                    <textarea class="form-control" ng-model="requestData.comment" rows="3"></textarea>
    ...
    <script type="text/ng-template" id="postponeLeadModal.html">
        <div class="modal-header">
            <h3 class="modal-title">Postpone Lead</h3>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
					<div class="sub-title">New Start Date</div>
	                <div>
	                    <input placeholder="Select start date" type="date" ng-model="requestData.data.date"  />
	                </div>
	                <div class="sub-title">Any Comment</div>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-success" type="button" ng-click="updateStatus()" ng-disabled="!requestData.data.date">Update</button>
