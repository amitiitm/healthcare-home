...
@section('content')
    ...
    <div ng-controller="operationLeadVendorSuggestionCtrl" id="lead-view">
        <div class="page-title">
            <div class="title">
                <span>Lead: <% $model['lead']->customer_name%></span>
                <small ng-show="lead.patient.name">({{lead.patient.name}})</small>
                <span class="badge badge-success badge-large bg-success"><a href="/refresh_caching/preferred_caregivers">Refresh Caching</a></span>
